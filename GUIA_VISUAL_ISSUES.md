...
**⚠️ IMPORTANTE:** Copia DESDE la primera línea (`---`) hasta la última línea del archivo.

---

### 3️⃣ Ve a crear una nueva issue
...
Pero necesitas instalar GitHub CLI primero (ver LEEME_ISSUES.md).

---

## 📞 Más Ayuda

- **Guía completa:** [LEEME_ISSUES.md](LEEME_ISSUES.md)
- **Guía detallada:** [docs/COMO_CREAR_ISSUES.md](docs/COMO_CREAR_ISSUES.md)
- **Script:** [docs/issues/create-issues.sh](docs/issues/create-issues.sh)
