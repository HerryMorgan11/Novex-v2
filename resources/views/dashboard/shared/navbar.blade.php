<nav class="navbar">
	<div class="navbar-left">
		<button class="nav-back" aria-label="Volver" title="Volver"><iconify-icon icon="entypo:home"></iconify-icon></button>
				...
				<div class="notif-body">
					...
					<div class="notif-card unread critical">
						...
						<div class="notif-content">
							...
							<p class="notif-desc">La factura #INV-2023 para ClienteCorp ha sobrepasado su fecha de pago por 5 días.</p>
						...
						<button class="notif-more" aria-label="Más opciones"><iconify-icon icon="lucide:more-vertical"></iconify-icon></button>
					</div>
					...
					<div class="notif-card unread warning">
						...
						<div class="notif-content">
							...
							<p class="notif-desc">El artículo "Procesador AMD Ryzen 9" tiene 3 unidades restantes (mínimo: 10).</p>
							<div class="notif-meta">
