...
<div style="max-width:680px; margin:0 auto; padding:20px;">
    ...
    <div style="display:flex; align-items:center; gap:12px; margin-bottom:28px;">
        <a href="{{ route('reminders.index') }}" style="color:#007aff; font-size:14px; text-decoration:none;">← Volver</a>
        <h1 style="font-size:24px; font-weight:700; color:#1c1c1e; margin:0;">Nuevo Recordatorio</h1>
    </div>
