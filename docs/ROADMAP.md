# 🗺️ Roadmap Novex v2 ERP - Resumen Ejecutivo
...
### 🖥️ Fase 4: Dashboard Foundation (5-7 días)
...
- [Diseño Base de Datos](./baseDeDatos.md)
- [Diseño Landing](./landingDesign.md)
- [Landing + Dashboard Architecture](./landingPublica.md)
- [Plan Detallado de Fases](./PROJECT_PHASES.md)
